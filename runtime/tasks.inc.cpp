...
static lean_task_object *pending_task(obj_arg closure = nullptr, bool keep_alive = false) {
...
extern "C" LEAN_EXPORT obj_res lean_task_map_core(obj_arg f, obj_arg t, unsigned,
    ...
    auto *result = pending_task(mk_closure_3_2(task_map_fn, f, t), keep_alive);
...
extern "C" LEAN_EXPORT obj_res lean_task_bind_core(obj_arg t, obj_arg f, unsigned,
    ...
    auto *result = pending_task(mk_closure_3_2(task_bind_fn, t, f), keep_alive);
    schedule_task(result, lean_to_task(t));
    return (object*)result;
}
...
extern "C" LEAN_EXPORT bool lean_io_check_canceled_core() {
    auto *t = (lean_task_object*)(uintptr_t)lasm_task_current();
