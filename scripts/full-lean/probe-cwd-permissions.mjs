// Differential inherited-cwd permission probe. Original upstream sources are not edited.
...
const evidence = { leanCommit, source, executedSource, sourceSha256: digest(bytes),
  scope: 'Supplementary Linux inherited-cwd permission comparison; not an upstream-suite result.',
