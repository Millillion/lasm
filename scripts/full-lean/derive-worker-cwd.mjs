...
const derivation = { scope: 'Private worker startup after cwd deletion. Unchanged Wasm and Lean inputs; generated compiler and future linked programs use the same updated prelude.',
