...
for (const synchronous of [true, false]) {
  test(`file creation modes, permissions, and reopening through ${synchronous ? 'direct' : 'worker'} IO`, async t => {
...
test('POSIX pipe and duplicated descriptors stay close-on-exec', { skip: !posix }, () => {
...
test('POSIX TCP descriptors are nonblocking and close-on-exec before engine handoff', { skip: !posix }, () => {
