...
`);
  ...
  const files = ['main.mjs', 'module.wasm', 'index.mjs', 'runtime.mjs', 'scheduler.mjs', 'node-host.mjs', 'node-network.mjs', 'node-process.mjs', 'node-udp.mjs', 'node-system.mjs', 'node-signal.mjs', 'thread-id.cjs', 'native-files.mjs', 'native-dns.mjs', 'native/manifest.json', 'wasi.mjs', 'manifest.json'];
