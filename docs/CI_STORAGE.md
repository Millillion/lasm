...
the actual hosted save/restore result is still pending. This control does not
establish that a full compiler checkpoint or end-user distribution is ready.
