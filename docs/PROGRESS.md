...
**Changed:** [Installed `.24` matches 24 filesystem-device observations per engine](evidence/filesystem-devices-installed-2026-09-24.json) in Node, Deno and Bun on Linux x64, including six complete error values. Source-hidden deployments match native interpreted and compiled Lean. Every guard released; peak memory stayed below 3.45 GiB. Pushes await restored SSH credentials.
