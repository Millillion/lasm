...
**Changed:** [Eight module-data unit controls](evidence/application-module-data-units-2026-09-24.json) pass for automatic copying, search precedence, relocation, cache invalidation and explicit overrides. Native Lake/import CI and installed-package validation are pending. The guarded full Bun application campaign continues.
