...
**Changed:** [Concurrent helper wait/notify passes](evidence/wasmtime-helper-concurrency-2026-09-24.json) in all three stock engines; valid legacy exceptions are rejected by the helper. Prepared a source-reviewed sparse high-address probe with base pages and the same 1 GiB process guard. Full Lean integration remains open.
