...
The v144 Node campaign's latest saved checkpoint records **801 passes, zero
failures or resource aborts, and 3,095 pending registrations**. All 3,896 tests
...
The [704-test checkpoint](evidence/node-broad-v144-split-optimization-checkpoint704-2026-09-22.json),
