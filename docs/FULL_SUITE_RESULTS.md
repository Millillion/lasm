...
The v144 Node campaign's latest saved checkpoint records **704 passes, zero
failures or resource aborts, and 3,192 pending registrations**. All 3,896 tests
...
The [602-test checkpoint](evidence/node-broad-v144-split-optimization-checkpoint602-2026-09-22.json),
