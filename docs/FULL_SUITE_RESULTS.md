...
The v144 Node campaign's latest saved checkpoint records **903 passes, zero
failures or resource aborts, and 2,993 pending registrations**. All 3,896 tests
...
The [801-test checkpoint](evidence/node-broad-v144-split-optimization-checkpoint801-2026-09-22.json),
