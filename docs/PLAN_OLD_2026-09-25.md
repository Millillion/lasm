# OLD PLAN — archived 2026-09-25

This document is historical reference only. It is superseded by [the current plan](PLAN.md). Its priorities, acceptance gates, and historical completion claims are not the current implementation scope.

The complete previous `docs/PLAN.md`, including its earlier historical plan, is preserved verbatim below.
